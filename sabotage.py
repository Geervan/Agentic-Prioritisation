...
# Cleaner logging format (force=True to override any other config)
...
def extract_dataset(dataset_key: str, keywords: List[str] = None) -> bool:
    ...
    # Silence extractor logs (only show warnings/errors)
    logging.getLogger("extraction.extract_cypress_tests").setLevel(logging.WARNING)
...
def main() -> int:
    ...
    logger.info("=" * 60)
    logger.info("Agentic Test Prioritizer Starting...")
    logger.info("=" * 60)
